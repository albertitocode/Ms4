<?php foreach ($usuario as $usu) { ?>
    ...
    <div class="col-md-6 col-lg-4">
        ...
        <div class="form-group"> <label for="usuario_apellido_1">Primer apellido</label>
            ...
            <span class="small-text text-danger" id="error_usuario_apellido_1"></span>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6 col-lg-4">
        ...
        <div class="form-group">
            ...
            <span class="small-text text-danger" id="error_usuario_apellido_2"></span>
        </div>
        <div class="form-group">
            ...
            <span class="small-text text-danger" id="error_usuario_num_identificacion"></span>
        </div>
