...
<div class="mt-5">
    ...
    <form action="<?php echo getUrl("Reportes", "Reportes", "postReporteVia"); ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <option value="via">Daños en la via</option>
                            ...
                            <div class="mt-5">
                                <input type="submit" id="btnReporteVia value="Enviar" class="btn btn-success">
                            </div>
                        </div>
                    </div>
                </div>
