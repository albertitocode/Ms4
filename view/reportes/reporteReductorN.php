...
<div class="mt-5">
    ...
    <form action="<?php echo getUrl("Reportes", "Reportes", "postReporteReductorNuevo"); ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <option value="reduct">Reductor</option>
                            ...
                            <div class="mt-5">
                                <input type="submit" id="btnReporteSeniN" value="Enviar" class="btn btn-success">
                            </div>
                        </div>
                    </div>
                </div>
