        ...
        $usu = pg_fetch_all($obj->consult($sql));
            ...
            if ($reestablecer) {
                ...
                try {
                    ...
                    $mailer->Body = 'Hola ' . $nombre_usuario . 'sabemos que tienes problemas para iniciar sesion, escribe el siguiente codigo para poder ingresar: ' . $codigo . ' este codigo se deshabilitará en 5 minutos';
